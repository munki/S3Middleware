...
struct S3MiddlewareTests {
    ...
    @Test func canonicalRequestHashIsExpected1() {
    ...
    @Test func canonicalRequestHashIsExpected2() {
    ...
    /// by the Python version of this plugin
    @Test func signingRequestGeneratesExpected1() {
        let builder = headersBuilder(TEST_URL_1)
    ...
    @Test func signingRequestGeneratesExpected2() {
        let builder = headersBuilder(TEST_URL_2)
        let signingKey = builder.createSignatureKey()
        let signature = HMAC<SHA256>.authenticationCode(
            for: Data(builder.stringToSign().utf8),
    ...
    @Test func generatedHeadersAreExpected1() {
        let builder = headersBuilder(TEST_URL_1)
    ...
    @Test func generatedHeadersAreExpected2() {
        let builder = headersBuilder(TEST_URL_2)
        let headers = builder.createHeaders()
        let x_amz_date = headers["x-amz-date"] ?? ""
        let x_amz_content_sha256 = headers["x-amz-content-sha256"] ?? ""
